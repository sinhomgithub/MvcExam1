namespace MvcExam1.Models
{
	public static class RepositoryHelper
	{
		...
		public static 客戶分類清單Repository Get客戶分類清單Repository()
		{
			var repository = new 客戶分類清單Repository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static 客戶分類清單Repository Get客戶分類清單Repository(IUnitOfWork unitOfWork)
		{
			var repository = new 客戶分類清單Repository();
		...
		public static 客戶總合資訊Repository Get客戶總合資訊Repository()
		{
			var repository = new 客戶總合資訊Repository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static 客戶總合資訊Repository Get客戶總合資訊Repository(IUnitOfWork unitOfWork)
		{
			var repository = new 客戶總合資訊Repository();
			repository.UnitOfWork = unitOfWork;
			return repository;
